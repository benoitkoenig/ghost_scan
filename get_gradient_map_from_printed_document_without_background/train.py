...
loggerCb = tf.keras.callbacks.CSVLogger('./logs/get_gradient_map_from_printed_document_without_background.csv')

model.fit(gen, steps_per_epoch=10, epochs=40, callbacks=[reduceLrCb, loggerCb])
model.save_weights('./weights/get_gradient_map_from_printed_document_without_background.h5', overwrite=True)
